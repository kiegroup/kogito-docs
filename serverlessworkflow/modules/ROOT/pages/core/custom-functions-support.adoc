...
<1> Tells {product_name} to send the payload as a CloudEvent. Default is `false`. See [Kubernetes Service Discovery](../cloud/quarkus/kubernetes-service-discovery.adoc) for supported Scheme and Kubernetes GVK 
