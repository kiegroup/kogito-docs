...
--
[.card-title]
xref:service-orchestration/configuring-openapi-services-endpoints.adoc[Configuring OpenAPI services endpoints]
[.card-description]
...
--
[.card-title]
xref:eventing/event-correlation-with-workflows.adoc[Event correlation with workflows]
[.card-description]
Learn how to configure event correlation in your Serverless Workflow application.
--
